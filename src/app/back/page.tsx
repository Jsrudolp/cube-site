  ...
  return (
    ...
    >
      <Flashlight fullscreen>
        ...
        <div className="relative mx-auto px-5 sm:px-7 pb-12 max-w-[52rem] text-[17px] sm:text-[18px] leading-[1.4]">

          {/* Header */}
          <div className="mb-8 sm:mb-12">
            <h1 className="text-[28px] sm:text-[32px] tracking-tight leading-[1.1]">Jake Rudolph</h1>
            <p className="mt-2 text-[16px] sm:text-[17px] text-white/50 leading-[1.5]">To be honest, still figuring it out</p>
          </div>
          ...
          <footer className="pt-8 border-t border-white/10">
            ...
            <p className="mt-6 text-[13px] sm:text-[14px] leading-[1.6] italic text-white/35">
